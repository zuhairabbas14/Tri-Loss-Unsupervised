...
def main(config):
    svhn_loader, svhn_val_loader, mnist_loader, mnist_val_loader = get_loader(config)
    print("loaded")
    solver = Solver(config, svhn_loader, svhn_val_loader, mnist_loader, mnist_val_loader)
